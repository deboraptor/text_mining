...
nouveaux_commentaires = [
    ...
    "J'aime Bordeciel",
    "Merci, de la reco mais vraiment un des pires jeux auxquels j'ai pu jouer",
    "Franchement, j'ai été bloqué pendant des heures dans le prologue, c'était trop long et quand\
    j'ai quitté le jeu j'avais passé trop de temps et j'ai donc pas pu me faire rembourser"
]




df = pd.read_csv("../data/commentaires_lematise.csv", sep=",", skiprows=1, usecols=[1, 2],names=['sentiment', 'commentaire'])
